...
const features = [
  { icon: Activity, title: "AI Medical Imaging", body: "Chest X-ray, brain MRI and skin lesion analysis with confidence scoring.", to: "/diagnostics" },
  { icon: Stethoscope, title: "Symptom Checker", body: "Add your symptoms and see the three most likely conditions with precautions.", to: "/symptoms" },
  { icon: Salad, title: "Diet Planner", body: "Calorie-aware meal plans tuned to diabetes, blood pressure and your goals.", to: "/diet" },
  { icon: ScanLine, title: "Prescription OCR", body: "Photograph a handwritten prescription and get a clean, structured medicine list.", to: "/prescription" },
  { icon: Store, title: "E-Pharmacy", body: "Authentic medicines and devices, delivered in 60 minutes in major cities.", to: "/pharmacy" },
];

const steps = [
  { icon: UploadCloud, title: "Upload", body: "Add a scan, prescription photo or a few symptoms — no account needed to try." },
  { icon: Brain, title: "Analyze", body: "Our clinical models review your input in seconds and score their own confidence." },
  { icon: ClipboardCheck, title: "Get Results", body: "Read plain-language findings, precautions and next steps you can share with a doctor." },
];
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-14 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:px-8 lg:py-24">
          ...
          >
            <Badge variant="secondary" className="gap-1.5 rounded-full bg-primary-soft px-3.5 py-1.5 text-accent-foreground">
              <Sparkles className="size-3.5" /> Trusted by 40,000+ families
            </Badge>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
            Five clinical-grade modules that work together, from first symptom to medicine at your door.
          </p>
        </div>
      ...
      <section className="border-y border-border/60 bg-card/40 py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {steps.map((s, i) => (
              <Card key={s.title} className="card-hover rounded-3xl border-border/60 p-8 text-center shadow-soft">
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <Card className="gradient-primary overflow-hidden rounded-4xl border-0 p-10 text-center shadow-lift sm:p-16">
          <h2 className="text-3xl font-semibold text-primary-foreground sm:text-4xl">
            Start your free health check today
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-primary-foreground/85">
            No card required. Your first scan analysis, symptom check and diet plan are on us.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            ...
            <Button size="lg" variant="outline" className="rounded-full border-primary-foreground/40 bg-transparent px-7 text-primary-foreground transition-transform hover:scale-[1.03] hover:bg-primary-foreground/10" asChild>
              <Link to="/chat">Talk to the AI assistant</Link>
            </Button>
          </div>
        </Card>
      </section>
